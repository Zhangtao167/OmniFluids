#!/bin/bash
# =============================================================================
# Exp24: Self-Training + Soft-L∞ + Multi-Step + Relative PDE Loss
# 
# Based on exp22, with one key addition:
#   - use_relative_loss=1: Normalize PDE residual by target per-field RMS
#     This prevents fields with large numerical ranges (e.g., psi) from
#     dominating the total loss.
# 
# Implementation: residual / target_rms_per_field.detach().clamp(min=1e-8)
# 
# Phase 1 (steps 0-29999): Pure GRF training
#   - PDE loss + Soft-L∞ + Multi-step rollout + Relative Loss
...
#   - use_relative_loss=1 (normalize residual by target per-field RMS)
# =============================================================================
...
EXP_NAME="exp24_self_training_linf_multistep_normed_mse"
GPU_IDS=${1:-"6,7"}  # Default: GPU 2,3 (GPU 0,1 used by exp21)
...
# ============================================================
# NEW in Exp24: Relative Loss (normalize by target per-field RMS)
# ============================================================
...
echo "========================================================================="
echo "  Exp24: Self-Training + Soft-L∞ + Multi-Step + Relative PDE Loss"
echo "========================================================================="
echo "  GPU_IDS: $GPU_IDS"
echo "  NUM_GPUS: $NUM_GPUS"
echo ""
echo "  *** NEW in Exp24: Relative Loss ***"
echo "    use_relative_loss=$USE_RELATIVE_LOSS"
echo "    Implementation: residual / target_rms_per_field.detach().clamp(min=1e-8)"
echo "    Prevents psi from dominating loss due to large numerical range"
echo ""
...
echo "    - Pure GRF input, PDE + Soft-L∞ + Multi-step + Relative Loss"
echo ""
