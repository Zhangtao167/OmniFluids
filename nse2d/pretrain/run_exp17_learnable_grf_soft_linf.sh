#!/bin/bash
# =============================================================================
# Exp17: Learnable GRF + Soft-L∞ Loss (Multi-GPU via Accelerate)
# 
# 基于 exp14，增加 soft-L∞ loss
# 
# Phase 1 (steps 0-19999): Pure GRF training with physics loss + soft-L∞
...
EXP_NAME="exp17_learnable_grf_soft_linf"
GPU_IDS=${1:-"0,1,2,3"}
...
echo "========================================================================="
echo "  Exp17: Learnable GRF + Soft-L∞ Loss (Multi-GPU via Accelerate)"
echo "========================================================================="
