#!/bin/bash
# =============================================================================
# Exp26: Self-Training + Soft-L∞ + Multi-Step + Fixed-Scale Relative PDE Loss
# 
# Based on exp22, with one key addition:
#   - use_relative_loss=1 + relative_loss_fixed_scales=<5 values>
#     Normalize each field's PDE residual by a fixed per-field scale
#     derived from the training data statistics used by GRF generation.
# 
# Implementation: residual[..., c] / fixed_scale[c]
# 
# Phase 1 (steps 0-29999): Pure GRF training
#   - PDE loss + Soft-L∞ + Multi-step rollout + Fixed-Scale Relative Loss
...
#   - use_relative_loss=1
#   - relative_loss_fixed_scales=<fixed n,U,vpar,psi,Ti scales>
# =============================================================================
...
EXP_NAME="exp26_self_training_linf_multistep_fixed_normed_mse"
GPU_IDS=${1:-"0,1"}  # Default: reuse H800 t1 GPUs freed from exp21
...
# ============================================================
# NEW in Exp26: Fixed-Scale Relative Loss
# ============================================================
USE_RELATIVE_LOSS=1  # 1=enable, 0=disable (backward compatible)
RELATIVE_LOSS_FIXED_SCALES="1.6727051163728381,0.6794209510140281,1.6971852768314346,30.033987410809285,2.0640414017914184"
# Order: n,U,vpar,psi,Ti
# Source: train data std over t in [250, 300], matching GRF scale derivation window.
...
echo "========================================================================="
echo "  Exp26: Self-Training + Soft-L∞ + Multi-Step + Fixed-Scale Relative PDE Loss"
echo "========================================================================="
echo "  GPU_IDS: $GPU_IDS"
echo "  NUM_GPUS: $NUM_GPUS"
echo ""
echo "  *** NEW in Exp26: Fixed-Scale Relative Loss ***"
echo "    use_relative_loss=$USE_RELATIVE_LOSS"
echo "    relative_loss_fixed_scales=$RELATIVE_LOSS_FIXED_SCALES"
echo "    Implementation: residual[..., c] / fixed_scale[c]"
echo "    Scale order: n,U,vpar,psi,Ti"
echo ""
...
echo "    - Pure GRF input, PDE + Soft-L∞ + Multi-step + Fixed-Scale Relative Loss"
echo ""
...
/zhangtao/envs/rae/bin/accelerate launch --multi_gpu \
    ...
    --relative_loss_fixed_scales "$RELATIVE_LOSS_FIXED_SCALES" \
