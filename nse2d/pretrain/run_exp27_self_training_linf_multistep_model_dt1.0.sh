#!/bin/bash
# =============================================================================
# Exp27: Self-Training + Soft-L∞ + Multi-Step, Model dt=1.0
# 
...
#   - rollout_dt=1.0 (match model step to data step)
#   - main_process_port=29727 (avoid exp22 port conflict)
# =============================================================================
...
EXP_NAME="exp27_self_training_linf_multistep_model_dt1.0"
GPU_IDS=${1:-"6,7"}  #
...
echo "========================================================================="
echo "  Exp27: Self-Training + Soft-L∞ + Multi-Step, Model dt=1.0"
echo "========================================================================="
...
echo ""
echo "  rollout_dt=1.0 (same as data step)"
